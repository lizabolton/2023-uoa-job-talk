...
You can run this code to download the code to your current working directory. Make sure you have the right .Rproj open.
...
.footnote[RStudio article:  https://reprex.tidyverse.org/articles/reprex-dos-and-donts.html]  

---
## Other things to know

* Please try to use use reprexes when asking for help on Ed Discussion!
  * ❌ Screenshots
